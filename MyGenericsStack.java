...
//Method to Check whether the stack is full or not
    ...
    public void Arrayprint(char exp[]) {
 ...
 // Deletes middle of stack of size
  ...
  //Method to Check whether the given Expression is Balanced or Not
  		public boolean BalanceParanthesis(char exp[]) throws Exception{	
  			MyGenericsStack<Character> s = new MyGenericsStack<Character>(20);
  	         for(int i=0;i<exp.length;i++)
  			{
  ...
  //Method to check whether the parenthesis are matching or not
  		public boolean MatchingPair(char char1,char char2){
  			if(char1=='('&& char2==')')
  				return true;
  			else if(char1=='{'&& char2=='}')
  				return true;
